...
def MsgAppOffSave(student, teacher, opening, price, mtype, counter, accepted):
    ...
    if counter==True:
        ...
        offercontent = "COUNTER OFFER: " + str(student) + " has offered the job of the " + str(opening) + " at $" + str(price) + "/Hour. This order is currently pending acceptance from " + str(teacher) + " ."
        applycontent = "COUNTER OFFER: " + str(teacher) + " has applied for the job of the " + str(opening) + " at $" + str(price) + "/Hour. This order is currently pending acceptance from " + str(student) + " ."
        if mtype == "offer":
    ...
    if counter==False:
        if accepted == False:
            offertitle = "Offer for job of the " + str(opening)
            applytitle = "Application for the job of a " + str(opening)
            offercontent = "OFFER: " + str(student) + " has offered the job of the " + str(opening) + " at $" + str(price) + "/Hour. This order is currently pending acceptance from " + str(teacher) + " ."
            applycontent = "APPLICATION: " + str(teacher) + " has applied for the job of the " + str(opening) + " at $" + str(price) + "/Hour. This order is currently pending acceptance from " + str(student) + " ."
        ...
        if accepted == True:
            ...
            offercontent = "ACCEPTED: " + str(student) + " has accepted " + str(opening) + " at $" + str(price) + "/Hour. This order is in progress."
            applycontent = "ACCEPTED: " + str(teacher) + " has accepted " + str(opening) + " at $" + str(price) + "/Hour. This order is in progress."
